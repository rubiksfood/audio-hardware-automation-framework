"""Tests for the inspect-devices CLI command."""
...
def test_inspect_devices_displays_device(
...
def test_inspect_devices_outputs_json(
    monkeypatch: MonkeyPatch,
) -> None:
    device = create_test_device()
...
def test_inspect_devices_exits_when_no_devices(
    monkeypatch: MonkeyPatch,
) -> None:
    def fake_list_devices(
        self: SoundDeviceBackend,
...
def test_inspect_devices_handles_backend_error(
    monkeypatch: MonkeyPatch,
) -> None:
    def raise_enumeration_error(
        self: SoundDeviceBackend,
    ) -> list[AudioDevice]:
